#!/usr/bin/env pwsh
# cate Remote Installation Script for Windows
# Usage: irm https://raw.githubusercontent.com/superyngo/cate/main/install.ps1 | iex
...
function Install-Cate {
    Write-Info "=== cate Installation Script ==="
    Write-Info ""
    ...
    Write-Info ""
    Write-Info "Usage:"
    Write-Info "  $APP_NAME <filename>       - Display file with auto-detected encoding"
    Write-Info "  $APP_NAME -e <encoding> <filename> - Specify encoding"
    Write-Info "  $APP_NAME -n <filename>    - Show line numbers"
...
function Uninstall-Cate {
    Write-Info "=== cate Uninstallation Script ==="
    Write-Info ""
